...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'acme.demo.note_manager' => 'getAcme_Demo_NoteManagerService',
    ...
    /**
     * Gets the 'acme.demo.note_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Acme\DemoBundle\NoteManager A Acme\DemoBundle\NoteManager instance.
     */
    protected function getAcme_Demo_NoteManagerService()
    {
        return $this->services['acme.demo.note_manager'] = new \Acme\DemoBundle\NoteManager($this->get('security.secure_random'), __DIR__);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_43f75b53964ee2e90cf4c9a47099f08f64144421b2501fe7844e4598786aa55e');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_43f75b53964ee2e90cf4c9a47099f08f64144421b2501fe7844e4598786aa55e');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_43f75b53964ee2e90cf4c9a47099f08f64144421b2501fe7844e4598786aa55e');
    ...
    {
        return $this->services['fos_rest.mime_type_listener'] = new \FOS\RestBundle\EventListener\MimeTypeListener(array('json' => array(0 => 'application/json', 1 => 'application/json;version=1.0', 2 => 'application/json;version=1.1')), $this->get('fos_rest.format_negotiator'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($e, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $c, 'main', $f, $a), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '54819826acc46', $a, $c), 3 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $e, $c)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), new \Symfony\Component\Security\Http\HttpUtils($d, $d), 'main', $f, NULL, NULL, $a));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/Acme/DemoBundle/Resources/translations/AcmeDemoBundle.de.yml'), 'de', 'AcmeDemoBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/Acme/DemoBundle/Resources/translations/AcmeDemoBundle.en.yml'), 'en', 'AcmeDemoBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/Acme/DemoBundle/Resources/translations/AcmeDemoBundle.es.yml'), 'es', 'AcmeDemoBundle');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => (dirname(dirname(dirname(__DIR__))).'/src/Acme/DemoBundle/Resources/config/validation.yml')));
    ...
    {
        return $this->services['jms_serializer.metadata.file_locator'] = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/assetic-bundle/Symfony/Bundle/AsseticBundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'FOS\\RestBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'Nelmio\\ApiDocBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/config/serializer'), 'FOS\\HttpCacheBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/http-cache-bundle/Resources/config/serializer'), 'Bazinga\\Bundle\\HateoasBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/willdurand/hateoas-bundle/Bazinga/Bundle/HateoasBundle/Resources/config/serializer'), 'Hautelook\\TemplatedUriBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/hautelook/templated-uri-bundle/Hautelook/TemplatedUriBundle/Resources/config/serializer'), 'Bazinga\\Bundle\\RestExtraBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/willdurand/rest-extra-bundle/Resources/config/serializer'), 'Acme\\DemoBundle' => (dirname(dirname(dirname(__DIR__))).'/src/Acme/DemoBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer')));
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $b = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_API' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
